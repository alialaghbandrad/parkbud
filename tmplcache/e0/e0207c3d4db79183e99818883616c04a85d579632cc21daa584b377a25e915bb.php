...
/* admin/rules_list.html.twig */
class __TwigTemplate_489819245541b5c0b82999b45fdcb71927aae164108bcab8a1580a7baacd308b extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("admin/master_admin.html.twig", "admin/rules_list.html.twig", 1);
    ...
    <div class=\"table-responsive\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["r"]) {
            ...
            echo "</td>
                        <td>
                            <a class=\"btn btn-primary btn-sm active\" role=\"button\" aria-pressed=\"true\" href=\"/admin/rules/edit/";
            // line 54
            ...
            echo "\">edit</a>
                            ...
                            <a class=\"btn btn-primary btn-sm active\" role=\"button\" aria-pressed=\"true\" href=\"/admin/rules/delete/";
            // line 56
...
";
    ...
    {
        return "admin/rules_list.html.twig";
    }
    ...
    {
        return new Source("{% extends \"admin/master_admin.html.twig\" %}
            ...
            <tbody>
                {% for r in rulesList %}
                    <tr>
                        ...
                        <td>
                            <a class=\"btn btn-primary btn-sm active\" role=\"button\" aria-pressed=\"true\" href=\"/admin/rules/edit/{{ r.id }}\">edit</a>
                            
                            <a class=\"btn btn-primary btn-sm active\" role=\"button\" aria-pressed=\"true\" href=\"/admin/rules/delete/{{ r.id }}\">delete</a>
                        </td>
                    </tr>
                {% endfor %}
            </tbody>
...
{% endblock %}", "admin/rules_list.html.twig", "E:\\Xampp\\htdocs\\parkbud\\parkbud\\templates\\admin\\rules_list.html.twig");
    }
}
